...
pub fn render_about_tab(ui: &mut egui::Ui, ui_state: &mut UiState) {
    ui.columns(2, |columns| {
        ...
        columns[0].vertical(|ui| {
            glass_card(ui, |ui| {
                tech_section(ui, "📱 Application Information", |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.colored_label(ModernTheme::TEXT_SECONDARY, "egui + eframe");
                        });
                    });
                });
            });
            ...
            glass_card(ui, |ui| {
                tech_section(ui, "👥 Credits", |ui| {
                    ...
                    ui.indent("thanks", |ui| {
                        ...
                        ui.colored_label(ModernTheme::TEXT_SECONDARY, "• Open Source Contributors");
                    });
                });
            });
            ...
            glass_card(ui, |ui| {
                tech_section(ui, "📄 License & Legal", |ui| {
                    ui.horizontal(|ui| {
                        ui.label("License:");
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
        ...
        // Right column - Updates and System Status
        columns[1].vertical(|ui| {
            glass_card(ui, |ui| {
                tech_section(ui, "🔄 Software Updates", |ui| {
            ...
            glass_card(ui, |ui| {
                tech_section(ui, "💻 System Information", |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Operating System:");
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.colored_label(ModernTheme::TEXT_SECONDARY, get_os_info());
                        });
                    });
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.colored_label(ModernTheme::TEXT_SECONDARY, get_memory_info());
                        });
                    });
                    ...
                    ui.horizontal(|ui| {
                        ...
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.colored_label(ModernTheme::TEXT_SECONDARY, get_gui_backend());
                        });
                    });

                    ui.add_space(StyleConstants::SPACING_SM);

                    if ui.add(small_button("📊 Detailed System Info")).clicked() {
            ...
            glass_card(ui, |ui| {
                tech_section(ui, "🌐 Links & Support", |ui| {
                    button_group(ui, |ui| {
                        if ui.add(secondary_button("🌐 GitHub Repository")).clicked() {
                            open_url("https://github.com/dvdripper/dvdripper");
                        }
                    });
                    ...
                    button_group(ui, |ui| {
                        if ui.add(secondary_button("🐛 Report Bug")).clicked() {
                            open_url("https://github.com/dvdripper/dvdripper/issues/new");
                        }
